...
For the eight time I tried to find out how far I could make it in [Advent of Code](https://adventofcode.com/2025/). Results for previous editions:
* 2018: 9 days
* 2019: 13 days
...
For years I've been telling myself that I've had enough, that I no longer have time, that I have other stuff to do. So far, AoC won with everything, although ususally I had a couple of stars left to collect at the end of the regular AoC schedule. This time it was only 12 days, and surprisingly I made it through pretty quickly.

Self-imposed rules for LLM usage:
...
* [Day 12 Python](12/d12.py) **N** : I reviewed A* and read about polyominos (**L**) without even applying it to the actual solution