...
print('Iteratively removed (set as pseudo-to_checkueue):', count_with_set(warehouse) == 43)
...
with open(input_path, mode='r', encoding='utf-8') as inp:
    ...
    print('Iteratively removed (set as pseudo-to_checkueue):', count_with_set(warehouse))
